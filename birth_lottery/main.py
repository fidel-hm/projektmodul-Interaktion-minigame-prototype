...
async def main():
    ...
    # --- Palette ---
    COLOR_BG     = (242, 238, 230)
    COLOR_SLOT   = (225, 220, 210)
    COLOR_WOOD   = (150, 110, 70)
    COLOR_ACCENT = (190, 170, 150)
    COLOR_TEXT   = (80, 75, 70)
    ...
    def reset_game():
        nonlocal box_x, has_grip, money, is_respawning, particles
        box_x = 150.0
        has_grip = False
        money = 0
        is_respawning = False
    ...
    while running:
        ...
        if state == STATE_START:
            ...
            pygame.draw.circle(screen, BTN_DARK, btn_center, btn_radius)
            pygame.draw.circle(screen, face, top_center, btn_radius)
        ...
        pygame.display.flip()
        clock.tick(60)
        await asyncio.sleep(0)  # required by pygbag for the browser event loop
